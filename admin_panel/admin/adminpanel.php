...
<head>
  <meta charset="UTF-8">
  <title>Origami-Tech/Admin Panel</title>
...
<div class="app">
 <div class="header">
  ...
  <div class="header-menu">
   ...
   <a class="menu-link notify" href="#">Services</a>
   <a class="menu-link" href="#">Evènement</a>
   <a class="menu-link notify" href="#">Contact</a>
   <a class="menu-link notify" href="#">Entreprise</a>
  </div>
 ...
 <div class="wrapper">
  <div class="left-side">
   ...
   <div class="side-wrapper">
    <div class="side-title">Evenement</div>
    <div class="side-menu">
     <a href="#">
